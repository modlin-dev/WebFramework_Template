...
// node_modules/scheduler/cjs/sch
...
var Root = function() {
  ...
  return jsx_dev_runtime.jsxDEV("main", {
    className: "flex justify-center items-center gap-6 flex-col h-screen",
    children: [
      "Hello, world!",
...
var Loading = function() {
  return jsx_dev_runtime2.jsxDEV("view", {
    ...
    children: [
      jsx_dev_runtime2.jsxDEV("svg", {
        ...
        children: jsx_dev_runtime2.jsxDEV("g", {
          children: [
...
var root_module_default = Layout;
client.hydrateRoot(document, jsx_dev_runtime3.jsxDEV(Layout, {}, undefined, false, undefined, this));
export {
  root_module_default as default
};
