      ...
      jsx_dev_runtime.jsxDEV("body", {
        ...
        children: [
          jsx_dev_runtime.jsxDEV("main", {
            className: "bg-white dark:bg-black flex justify-center items-center h-screen gap-8 flex-col animate-fade opacity-0",
            children: [
...
client.hydrateRoot(document, jsx_dev_runtime2.jsxDEV(root_default, {}, undefined, false, undefined, this));
