  ...
  return (
    <html lang="en">
      ...
      <body className="select-none">
        <main className="bg-white dark:bg-black flex justify-center items-center h-screen gap-8 flex-col animate-fade opacity-0">
          <svg
            version="1.1"
            id="Layer_1"
            x="0px"
		...
		l0,0C65.63-0.95,61.58,0.63,60.04,4.08z"
          ...
          <div className="w-40 h-2 rounded-full border-black dark:border-white border overflow-hidden">
